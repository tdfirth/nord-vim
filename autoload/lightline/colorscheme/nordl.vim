...
let s:nord10 = ["#5272AF", 12]
let s:nord11 = ["#BF616A", 1]
let s:nord12 = ["#D08770", 11]
let s:nord13 = ["#EBCB8B", 3]
let s:nord14 = ["#4F894C", 2]
let s:nord15 = ["#B48EAD", 5]
let s:nord16 = ["#E5E9F0", "NONE"]
let s:nord17 = ["#FFFFFF", "NONE"]

let s:p.normal.left = [ [ s:nord17, s:nord10 ], [ s:nord17, s:nord1 ] ]
let s:p.normal.middle = [ [ s:nord5, s:nord6 ] ]
let s:p.normal.right = [ [ s:nord17, s:nord1 ], [ s:nord17, s:nord1 ] ]
let s:p.normal.warning = [ [ s:nord1, s:nord13 ] ]
let s:p.normal.error = [ [ s:nord1, s:nord11 ] ]

let s:p.inactive.left =  [ [ s:nord0, s:nord3 ], [ s:nord0, s:nord3 ] ]
let s:p.inactive.middle = g:nord_uniform_status_lines == 0 ? [ [ s:nord5, s:nord6 ] ] : [ [ s:nord5, s:nord6 ] ]
let s:p.inactive.right = [ [ s:nord0, s:nord3 ], [ s:nord0, s:nord3 ] ]

let s:p.insert.left = [ [ s:nord17, s:nord14 ], [ s:nord17, s:nord1 ] ]
let s:p.replace.left = [ [ s:nord17, s:nord13 ], [ s:nord17, s:nord1 ] ]
let s:p.visual.left = [ [ s:nord17, s:nord12 ], [ s:nord17, s:nord1 ] ]
